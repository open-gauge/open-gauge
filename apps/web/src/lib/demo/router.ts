...
route("POST", "/api/v1/calibrations", ({ body }) => {
  ...
  const record: CalibrationRecord = {
    ...
    temperature_uncertainty: req.temperature_uncertainty ?? null,
    humidity: req.humidity ?? null,
    humidity_uncertainty: req.humidity_uncertainty ?? null,
    pressure: req.pressure ?? null,
    pressure_uncertainty: req.pressure_uncertainty ?? null,
