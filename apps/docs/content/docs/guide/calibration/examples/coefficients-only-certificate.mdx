...
Exercises the [coefficients-only](/docs/guide/calibration/coefficients-only) wizard path — for
...
- `r_squared`, `rmse`, `standard_error`, `max_error`, `decision_rule`, and
  ...
  badge for this record (see [Coefficients-only calibrations](/docs/guide/calibration/coefficients-only)).
